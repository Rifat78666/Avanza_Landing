...
const DecretoFlussiChecker = () => {
  ...
  return (
      ...
      <div style={{
        width: '100%',
        position: 'relative',
        backgroundImage: 'url("https://images.unsplash.com/photo-1530521954074-e64f6810b32d?auto=format&fit=crop&w=1920&q=80")',
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(236, 112, 99, 0.4) 0%, rgba(136, 78, 160, 0.4) 100%)',
          zIndex: 1
        }}></div>
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '800px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '3rem', marginBottom: '1rem', fontWeight: 'bold' }}>Decreto Flussi Checker</h1>
          <p style={{ fontSize: '1.2rem', marginBottom: '2rem' }}>Check eligibility for Italian immigration quotas.</p>
        </div>
      </div>
