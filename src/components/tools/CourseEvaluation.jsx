...
const CourseEvaluation = () => {
  ...
  const processAiEvaluation = async (sessionId) => {
    try {
      ...
      setTimeout(() => {
        // Create a mock text file to simulate the PDF download
        const blob = new Blob(["This is a simulated Course Evaluation Report. The real PDF will be generated by the AI backend once the payment gateway is live."], { type: "text/plain" });
        const url = window.URL.createObjectURL(blob);
        const a = document.createElement('a');
        a.href = url;
        a.download = `Avanza_Course_Evaluation_Mock.txt`;
